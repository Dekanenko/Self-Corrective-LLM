...
class CoVEAgent:
    ...
    def generate_initial_response(self, state: CoVEState) -> CoVEState:
        ...
        prompt = ContextualQAPrompt(input_variables=[
            "query", "context",
        ])
    ...
    def generate_questions(self, state: CoVEState) -> CoVEState:
        ...
        prompt = GenerateQuestionsPrompt(input_variables=[
    ...
    def answer_questions(self, state: CoVEState) -> CoVEState:
        ...
        prompt = QuestionAnswerPrompt(input_variables=[
            "question", "context",
        ])
    ...
    def verify_answers(self, state: CoVEState) -> CoVEState:
        ...
        verify_answers_prompt = QuestionAnswerVerificationPrompt(input_variables=[
            "initial_response", "question", "answer",
        ])
    ...
    def generate_new_response(self, state: CoVEState) -> CoVEState:
        ...
        prompt = RefineResponsePrompt(input_variables=[
            "initial_question", "initial_response", "questions", "answers", "verified_answer_mask",
        ])
